## drug-infomation (약 정보 검색)
 ...
 _( id: test123@gmail.com  /  pw:1234567 )_
  ...
  + 한번 로그인 한 후 로그아웃을 하기 전까지 사용자가 재로그인이 하지 않아도 로그인이 유지 됩니다.
  + 간단하게 회원가입도 가능하며 회원가입창에서 바로 자동로그인되며 메인화면으로 이동 됩니다.
  + 약의 이름을 검색하여 사용증상, 복용방법,부작용,주의사항에 대한 정보를 받아 볼 수 있습니다.
  + 검색시 정확한 약의 이름 혹은 '타이레놀','아스피린'과 같은 종류가 많은 이름으로 검색할 경우 리스트가 보여집니다.
  + 선택한 약에 대해서는 횟수(아침,점심,저녁,자기전)와 먹는시간대, 메모와 함께 간단한 정보를 저장/삭제 -
